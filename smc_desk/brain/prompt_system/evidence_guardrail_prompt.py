...
Do not confuse active-entry rejection with chart invisibility. annotation_context_authority may prequalify a causally proven, unspent zone as context-only after supersession. The AI may request that bounded display exception but cannot promote it back into the active POI, change bias, or create trade levels.
